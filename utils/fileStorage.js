...
const uploadFile = async (fileBuffer, originalName, mimeType) => {
  ...
  if (isAzureConfigured()) {
    try {
      console.log(`Azure Blob Storage configured. Uploading ${originalName} as ${uniqueName}...`);
...
const deleteFile = async (fileUrl) => {
  ...
  if (isAzureConfigured()) {
    ...
    try {
      ...
      // Azure URL format: https://<account>.blob.core.windows.net/<container>/<blob-name>
